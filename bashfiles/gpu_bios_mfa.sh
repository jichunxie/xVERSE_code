...
RESULT_DIR="/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_con2_64x16_nobatch_nobalance_randomprior5"
...
stdbuf -oL -eL "${RUN_CMD[@]}" \
  ...
  --lambda-prior-logvar-l2 2e-4 \
  --lambda-prior-factor-l2 2e-4\
