...
RESULT_DIR="/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_kl1e-4_con2_256x16_init_freeze_nobatch_dco"
...
stdbuf -oL -eL "${RUN_CMD[@]}" \
  ...
  --prior-freeze-after-init-epochs 2 \
