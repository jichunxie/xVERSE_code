...
RESULT_DIR="/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_con2_64x16_nobatch_nobalance_randomprior5_kl1e-3"
...
stdbuf -oL -eL "${RUN_CMD[@]}" \
  ...
  --prior-mu-init-radius 8 \
  --prior-mu-init-groups 8 \
  --prior-mu-init-local-radius 2 \
  --batch-emb-dim 0 \
