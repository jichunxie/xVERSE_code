...
RESULT_DIR="/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0521_celltype_text_128x8x015_reweight_con"
...
echo ">>> CELLTYPE_TEXT_EMB=${CELLTYPE_TEXT_EMB}"
