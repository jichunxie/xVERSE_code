...
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_kl5e-5_con2_64x16_nobatch_nobalance" "main_mfa" "encoder_hidden" "last_model.pth"
