...
# run_one_model "vae" "/hpc/group/xielab/xj58/pretrain_model_celltype/vae_all_tissue0517_con3_nobatch_kl1e-3_con1_reweight" "main_mfa" "encoder_hidden" "last_model.pth" --no-prior-viz
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_con2_64x4_nobatch_nobalance_klweighted" "main_mfa" "encoder_hidden" "last_model.pth"
