...
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_kl1e-4_con2_16x16_init_freeze_nobatch_dco" "main_mfa" "encoder_hidden" "last_model.pth"
