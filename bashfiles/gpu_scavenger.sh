...
run_one_model "vae" "/hpc/group/xielab/xj58/pretrain_model_celltype/vae_all_tissue0517_con3_nobatch_kl1e-3_con1" "main_mfa" "encoder_hidden" "last_model.pth" --no-prior-viz
