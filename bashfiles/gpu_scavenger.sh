...
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0521_celltype_text_32x8x015_reweight_con" "main_mfa" "encoder_hidden" "best_model.pth"
