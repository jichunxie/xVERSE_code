...
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0522_celltype_text_32x16_xversemask2" "main_mfa" "encoder_hidden" "best_model.pth"
