...
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0518_128x16_bio_noct_filter_kl3e-4-norm_v2_reweight_sharetheta" "main_mfa" "encoder_hidden" "last_model.pth"
