...
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_kl1e-5_con2_256x16_init_freeze_nobatch" "main_mfa" "encoder_hidden" "last_model.pth"
