...
run_one_model "vae" "/hpc/group/xielab/xj58/pretrain_model_celltype/vae_all_tissue0518_con1_nobatch_kl1e-4_ct_reweight" "main_mfa" "encoder_hidden" "last_model.pth" --no-prior-viz
# run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0518_128x16_bio_noct_filter_kl1e-4-norm" "main_mfa" "encoder_hidden" "last_model.pth"
