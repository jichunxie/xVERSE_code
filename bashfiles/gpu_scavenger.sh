...
run_one_model "mfa" "/hpc/group/xielab/xj58/pretrain_model_celltype/mfa_all_tissue0517_con2_8x4_nobatch_nobalance_kl3e-4" "main_mfa" "encoder_hidden" "last_model.pth"
