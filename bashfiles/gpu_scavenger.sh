...
run_one_model "gene_theta_encoder_hidden_h200" "/hpc/group/xielab/xj58/pretrain_model_celltype/gmmvae_all_tissue0513_gene_theta" "main_energy" "encoder_hidden"
